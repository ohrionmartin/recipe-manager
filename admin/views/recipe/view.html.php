 ...
 * Recipe View class
 */
class RecipemanagerViewRecipe extends JViewLegacy
{
	/**
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = RecipemanagerHelper::getActions('recipe', $this->item);
		// get input
	...
	protected function addToolBar()
	{
		...
		JToolbarHelper::title( JText::_($isNew ? 'COM_RECIPEMANAGER_RECIPE_NEW' : 'COM_RECIPEMANAGER_RECIPE_EDIT'), 'pencil-2 article-add');
		...
		else
		{
			...
			else
			{
				...
				{
					JToolbarHelper::versions('com_recipemanager.recipe', $this->item->id);
				}
				if ($this->canDo->get('core.create'))
				{
		...
		$help_url = RecipemanagerHelper::getHelpUrl('recipe');
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_($isNew ? 'COM_RECIPEMANAGER_RECIPE_NEW' : 'COM_RECIPEMANAGER_RECIPE_EDIT'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_recipemanager/assets/css/recipe.css", (RecipemanagerHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
		...
		$this->document->addScript(JURI::root() . "administrator/components/com_recipemanager/views/recipe/submitbutton.js", (RecipemanagerHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript'); 
