...
/**
 * Recipe_manager View class for the Ingredients
 */
class Recipe_managerViewIngredients extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		if ($this->getLayout() !== 'modal')
		{
			...
			Recipe_managerHelper::addSubmenu('ingredients');
		}
	...
	{
		JToolBarHelper::title(JText::_('COM_RECIPE_MANAGER_INGREDIENTS'), 'pencil');
		JHtmlSidebar::setAction('index.php?option=com_recipe_manager&view=ingredients');
		...
		if (Recipe_managerHelper::checkArray($this->items))
		{
			...
			{
				JToolBarHelper::custom('ingredients.exportData', 'download', '', 'COM_RECIPE_MANAGER_EXPORT_DATA', true);
			}
		}

		if ($this->canDo->get('core.import') && $this->canDo->get('ingredient.import'))
		{
			JToolBarHelper::custom('ingredients.importData', 'upload', '', 'COM_RECIPE_MANAGER_IMPORT_DATA', false);
		}

		// set help url for this view if found
		$help_url = Recipe_managerHelper::getHelpUrl('ingredients');
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_('COM_RECIPE_MANAGER_INGREDIENTS'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_recipe_manager/assets/css/ingredients.css", (Recipe_managerHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => JText::_('COM_RECIPE_MANAGER_INGREDIENT_NAME_LABEL'),
