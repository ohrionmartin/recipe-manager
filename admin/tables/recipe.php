 ...
 * Recipes Table class
 */
class RecipemanagerTableRecipe extends JTable
{
	/**
	...
	{
		parent::__construct('#__recipemanager_recipe', 'id', $db);

		// [Interpretation 7724] Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_recipemanager.recipe'));
	}	
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_RECIPEMANAGER_RECIPE_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_recipemanager.recipe.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_recipemanager.recipe.'.(int) $this->$k;
	}
